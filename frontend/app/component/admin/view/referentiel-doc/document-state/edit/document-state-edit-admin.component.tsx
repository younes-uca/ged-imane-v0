                ...
                <TabPanel header={t("documentState.tabPan")}>
                    <div className="formgrid grid">
                        ...
                        <div className="field col-6">
                            ...
                            <Dropdown id="style" value={item.style} options={documentsStateStyles} onChange={(e) => onDropdownChange(e, 'style')} placeholder={t("document.documentStatePlaceHolder")} className={classNames({ 'p-invalid': submitted && !item.style })} />
