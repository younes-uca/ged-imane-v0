...
const List = () => {
    ...
    const header = (
        <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
            <h5 className="m-0">{t("roleUtilisateur.header", { totalRecords: totalRecords })}</h5>
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    <DataTable ref={dt} value={items} selection={selectedItems} onSelectionChange={(e) => setSelectedItems(e.value as RoleUtilisateurDto[])} dataKey="id" className="datatable-responsive" globalFilter={globalFilter} header={header} responsiveLayout="scroll" >
                        <Column selectionMode="multiple" headerStyle={{ width: '4rem' }}> </Column><Column field="code" header={t("roleUtilisateur.code")} sortable></Column>
                        <Column field="libelle" header={t("roleUtilisateur.libelle")} sortable></Column>
                        <Column className='max-w-20rem' field="description" header={t("roleUtilisateur.description")} sortable></Column>
                    ...
                    <Dialog visible={deleteItemDialog} style={{ width: '450px' }} header={t("confirm")} modal footer={deleteItemDialogFooter} onHide={hideDeleteItemDialog}>
                        <div className="flex align-items-center justify-content-center">
                            ...
                            {item && (<span>{t("roleUtilisateur.deleteRoleUtilisateurConfirmationMessage")}</span>)}
                        </div>
                    </Dialog>
