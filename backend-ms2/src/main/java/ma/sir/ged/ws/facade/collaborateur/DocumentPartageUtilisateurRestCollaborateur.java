...
@RestController
@RequestMapping("/api/collaborateur/documentPartageUtilisateur/")
public class DocumentPartageUtilisateurRestCollaborateur  extends AbstractController<DocumentPartageUtilisateur, DocumentPartageUtilisateurDto, DocumentPartageUtilisateurHistory, DocumentPartageUtilisateurCriteria, DocumentPartageUtilisateurHistoryCriteria, DocumentPartageUtilisateurCollaborateurService, DocumentPartageUtilisateurConverter> {
    ...
    public DocumentPartageUtilisateurRestCollaborateur (DocumentPartageUtilisateurCollaborateurService service, DocumentPartageUtilisateurConverter converter) {
