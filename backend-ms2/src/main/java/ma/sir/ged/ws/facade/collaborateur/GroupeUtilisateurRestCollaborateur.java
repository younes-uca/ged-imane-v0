...
@RestController
@RequestMapping("/api/collaborateur/groupeUtilisateur/")
public class GroupeUtilisateurRestCollaborateur  extends AbstractController<GroupeUtilisateur, GroupeUtilisateurDto, GroupeUtilisateurHistory, GroupeUtilisateurCriteria, GroupeUtilisateurHistoryCriteria, GroupeUtilisateurCollaborateurService, GroupeUtilisateurConverter> {
    ...
    public GroupeUtilisateurRestCollaborateur (GroupeUtilisateurCollaborateurService service, GroupeUtilisateurConverter converter) {
