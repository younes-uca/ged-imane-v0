...
@RestController
@RequestMapping("/api/collaborateur/accessShare/")
public class AccessShareRestCollaborateur  extends AbstractController<AccessShare, AccessShareDto, AccessShareHistory, AccessShareCriteria, AccessShareHistoryCriteria, AccessShareCollaborateurService, AccessShareConverter> {
    ...
    public AccessShareRestCollaborateur (AccessShareCollaborateurService service, AccessShareConverter converter) {
