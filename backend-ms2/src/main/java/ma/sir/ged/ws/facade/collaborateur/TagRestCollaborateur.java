...
@RestController
@RequestMapping("/api/collaborateur/tag/")
public class TagRestCollaborateur  extends AbstractController<Tag, TagDto, TagHistory, TagCriteria, TagHistoryCriteria, TagCollaborateurService, TagConverter> {
    ...
    public TagRestCollaborateur (TagCollaborateurService service, TagConverter converter) {
