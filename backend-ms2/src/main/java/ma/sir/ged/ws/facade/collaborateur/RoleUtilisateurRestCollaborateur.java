...
@RestController
@RequestMapping("/api/collaborateur/roleUtilisateur/")
public class RoleUtilisateurRestCollaborateur  extends AbstractController<RoleUtilisateur, RoleUtilisateurDto, RoleUtilisateurHistory, RoleUtilisateurCriteria, RoleUtilisateurHistoryCriteria, RoleUtilisateurCollaborateurService, RoleUtilisateurConverter> {
    ...
    public RoleUtilisateurRestCollaborateur (RoleUtilisateurCollaborateurService service, RoleUtilisateurConverter converter) {
