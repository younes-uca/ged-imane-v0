...
@RestController
@RequestMapping("/api/collaborateur/entiteAdministrativeType/")
public class EntiteAdministrativeTypeRestCollaborateur  extends AbstractController<EntiteAdministrativeType, EntiteAdministrativeTypeDto, EntiteAdministrativeTypeHistory, EntiteAdministrativeTypeCriteria, EntiteAdministrativeTypeHistoryCriteria, EntiteAdministrativeTypeCollaborateurService, EntiteAdministrativeTypeConverter> {
    ...
    public EntiteAdministrativeTypeRestCollaborateur (EntiteAdministrativeTypeCollaborateurService service, EntiteAdministrativeTypeConverter converter) {
