...
@RestController
@RequestMapping("/api/collaborateur/documentPartageGroupe/")
public class DocumentPartageGroupeRestCollaborateur  extends AbstractController<DocumentPartageGroupe, DocumentPartageGroupeDto, DocumentPartageGroupeHistory, DocumentPartageGroupeCriteria, DocumentPartageGroupeHistoryCriteria, DocumentPartageGroupeCollaborateurService, DocumentPartageGroupeConverter> {
    ...
    public DocumentPartageGroupeRestCollaborateur (DocumentPartageGroupeCollaborateurService service, DocumentPartageGroupeConverter converter) {
