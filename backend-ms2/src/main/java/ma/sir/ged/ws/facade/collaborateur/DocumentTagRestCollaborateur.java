...
@RestController
@RequestMapping("/api/collaborateur/documentTag/")
public class DocumentTagRestCollaborateur  extends AbstractController<DocumentTag, DocumentTagDto, DocumentTagHistory, DocumentTagCriteria, DocumentTagHistoryCriteria, DocumentTagCollaborateurService, DocumentTagConverter> {
    ...
    public DocumentTagRestCollaborateur (DocumentTagCollaborateurService service, DocumentTagConverter converter) {
